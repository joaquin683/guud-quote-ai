...
- Si el cliente NO ha dado su nombre en la conversación → pregúntalo en la primera respuesta de forma natural ("¿Con quién tengo el gusto?" o incluirlo en la primera pregunta). Solo una vez.
...
BIEN: "Depende del alcance. Una landing page de alta conversión parte desde $1.200.000 CLP. ¿Necesitas vender online o mostrar tu servicio?"
...
JSON DE COTIZACIÓN:
{"proyecto":"Nombre del producto","servicio":"Desarrollo de Producto","QUOTE":true,"min":NÚMERO_EN_PESOS_CLP_ENTERO,"max":NÚMERO_EN_PESOS_CLP_ENTERO,"entregables":"Lista de entregables del desarrollo","tiempo":"Tiempo estimado","recomendacion":"Asesoría GÜÜD sobre el desarrollo y lanzamiento del producto"}

ESCALA DE PRECIOS EN PESOS CHILENOS (CLP) - USA SIEMPRE ESTOS RANGOS:
- MVP / Consultoría de producto: min 3000000, max 7000000
- App móvil completa (iOS + Android): min 6000000, max 15000000
- Plataforma web + app: min 8000000, max 20000000
IMPORTANTE: los números min/max son pesos chilenos enteros, sin puntos ni comas. Ejemplo correcto: 3000000`
}
...
{"proyecto":"Nombre del proyecto","servicio":"Producción Audiovisual / Fotografía","QUOTE":true,"entregables":"Lista concisa de entregables proporcionales al presupuesto cotizado","tiempo":"Tiempo de producción y entrega","min":NUMERO,"max":NUMERO,"recomendacion":"Recomendación técnica relevante","QUOTE":true}
