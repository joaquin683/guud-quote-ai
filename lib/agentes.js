...
AGENTES: branding | web | campana | contenido | estrategia | btl | ads | guerrilla | producto

Si no detectas servicio: {"agente": "estrategia", "servicio_detectado": "Consultoría creativa", "confianza": "baja", "razon": "ambiguo"}

GUÍA NUEVOS AGENTES:
- Evento, activación, pop-up, experiencia de marca, BTL, montaje, road show, lanzamiento → btl
- Meta ads, Facebook ads, Instagram ads, Google ads, TikTok ads, pauta, SEM, campañas pagadas → ads
- Guerrilla, intervención urbana, flash mob, viral, street marketing, marketing no convencional → guerrilla
- Producto, desarrollo de producto, producto físico, app, prototipo, merchandise, packaging → producto`
}
...
JSON DE COTIZACIÓN:
{"proyecto":"Nombre del evento/activación","servicio":"BTL / Experiencia de marca","min":NÚMERO,"max":NÚMERO,"entregables":"Lista de entregables del evento","tiempo":"Tiempo de producción","recomendacion":"Asesoría estratégica GÜÜD sobre la experiencia"}`
}
...
- Google Ads (Search, Display, YouTube): keywords, copies, landing pages, remarketing
...
- ¿Qué plataformas quieres usar? (Meta, Google, TikTok, LinkedIn)
...
JSON DE COTIZACIÓN:
{"proyecto":"Nombre de la campaña","servicio":"Gestión de Ads (Meta / Google / TikTok)","min":NÚMERO,"max":NÚMERO,"entregables":"Descripción de la gestión y creatividades incluidas","tiempo":"Duración del servicio","recomendacion":"Asesoría GÜÜD sobre la estrategia de pauta"}`
}
...
JSON DE COTIZACIÓN:
{"proyecto":"Nombre de la acción de guerrilla","servicio":"Marketing de Guerrilla","min":0,"max":0,"entregables":"Concepto creativo + estrategia de ejecución. Presupuesto: depende de la idea.","tiempo":"2-4 semanas de desarrollo conceptual","recomendacion":"Asesoría GÜÜD sobre el concepto e impacto esperado"}`
}
