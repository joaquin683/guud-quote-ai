...
const S = {
  ...
  hdr: { display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '6px 32px', borderBottom: 'none', flexShrink: 0, background: '#E8FF00', width: '100%', position: 'relative' },
